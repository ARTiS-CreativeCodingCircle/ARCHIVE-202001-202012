...
ArrayList<Page> generateAkitchWorks(Section section) {
  ...
  p = new DescriptionPage(section,
                          ...
                          new Image[]{ new Image(img1, marginHorizontal, marginVertical+titleBottomPadding,
                                       ...
                                       new Image(img2, marginHorizontal+int(areaWidth*(1.013/3.0)), marginVertical+titleBottomPadding,
                                                 int(areaWidth*(0.98/3.0)), int(areaWidth*(0.98/3.0))),
                                       new Image(img3, marginHorizontal+int(areaWidth*(2.01/3.0)), marginVertical+titleBottomPadding,
                                                 int(areaWidth*(0.98/3.0)), int(areaWidth*(0.98/3.0))),
                                       new Image(img4, marginHorizontal, marginVertical+titleBottomPadding+int(areaWidth*(1.42/3.0)),
                                                 int(areaWidth*(0.98/3.0)), int(areaWidth*(0.98/3.0))),
                                       new Image(img5, marginHorizontal+int(areaWidth*(1.013/3.0)), marginVertical+titleBottomPadding+int(areaWidth*(1.42/3.0)),
                                                 int(areaWidth*(0.98/3.0)), int(areaWidth*(0.98/3.0))),
                                       ...
                                       new Image(img7, marginHorizontal, marginVertical+titleBottomPadding+int(areaWidth*(2.82/3.0)),
                                                 int(areaWidth*(0.98/3.0)), int(areaWidth*(0.98/3.0))),
                                       new Image(img8, marginHorizontal+int(areaWidth*(1.013/3.0)), marginVertical+titleBottomPadding+int(areaWidth*(2.82/3.0)),
                                                 int(areaWidth*(0.98/3.0)), int(areaWidth*(0.98/3.0))),
